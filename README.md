...
2. Clone this repository in your Home directory:
    ...
    ```bash
    cd $HOME
    git clone https://github.com/hackb07/Luno-os.git
    ```
...
For more details or issues, please visit the repository’s [issues page](https://github.com/hackb07/Luno-os/issues).
...
[![Star History Chart](https://api.star-history.com/svg?repos=hackb07/Luno-os&type=Date)](https://www.star-history.com/#hackb07/Luno-os&Date)
